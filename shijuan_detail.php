...
?>
          ...
          <tr>
            <td>答案：</td>
            <td colspan="2"><input name="tktshitixx<?php echo mysql_result($query2,$i2,id)?>" type="text" id="tktshitixx<?php echo mysql_result($query2,$i2,id)?>" /></td>
            </tr>
...
?>
           <tr>
             <td width="9%" height="33">试题：</td>
             <td colspan="2">题目：<?php echo mysql_result($query2,$i2,timu)?>
                 <input name="xztshitida<?php echo mysql_result($query2,$i2,id)?>2" type="hidden" id="xztshitida<?php echo mysql_result($query2,$i2,id)?>2" value="<?php echo mysql_result($query2,$i2,daan)?>" /></td>
           </tr>
           <tr>
             <td>答案：</td>
