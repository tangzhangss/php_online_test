...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  ...
  <?php 
    $sql="select * from qunzuxinxi where zuyuanxuesheng like '%".$_SESSION['username']."；%'";
...
<p align="center"><a href="qunzuxinxi_list3.php?pagecurrent=1">首页</a>, <a href="qunzuxinxi_list3.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="qunzuxinxi_list3.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="qunzuxinxi_list3.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
