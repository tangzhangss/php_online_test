...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td width="192" bgcolor='#EBE2FE'>单选题数</td><td width="192" bgcolor='#EBE2FE'>单选题分值</td><td width="172" bgcolor='#EBE2FE'>填空题数</td>
    <td width="169" bgcolor='#EBE2FE'>填空题分值</td>
    <td width="145" align="left" bgcolor="#EBE2FE">判断题数</td>
    <td width="141" align="left" bgcolor="#EBE2FE">判断题分值</td>
...
?></td>
    ...
    <td width="145" align="left"><?php echo mysql_result($query,$i,panduantishu);?></td>
    <td width="141" align="left"><?php echo mysql_result($query,$i,panduanfenzhi);?></td>
