...
if ($addnew=="1" )
{
	...
	$sql="update jingwurenyuan set yonghuming='$yonghuming',mima='$mima',xingming='$xingming',xingbie='$xingbie',dianhua='$dianhua',weixin='$weixin',gangwei='$gangwei',shenfenzheng='$shenfenzheng',zhaopian='$zhaopian',beizhu='$beizhu' where yonghuming= '".$_SESSION["username"]."'";
	mysql_query($sql);
...
<body>
<p>修改警务人员： 当前日期： <?php echo $ndate; ?></p>
<?php
$sql="select * from jingwurenyuan where yonghuming='".$_SESSION["username"]."'";
