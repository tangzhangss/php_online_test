...
<frameset rows="121,*" framespacing="0" border="0" frameborder="0">
  ...
  <frameset cols="179,*">
    <frame id="frame_left" name="frame_left" src="mygo.php" scrolling="auto" target="frame_main" />
    <frame id="frame_main" name="frame_main" src="sy.php" scrolling="yes" target="frame_main" style=" margin-right:5px;" />
  </frameset>
  <noframes>
