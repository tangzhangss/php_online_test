...
<div class="amanagemenu_div">
  ...
  <div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add(2,0,'authority','','学生分组管理 ');
		//d.add(3,0,'authority','','课程信息管理 ');
		d.add(4,0,'authority','','试题库管理 ');
		d.add(5,0,'authority','','试卷管理 ');
		d.add(6,0,'authority','','成绩管理 ');

		d.add(12,1,'authority','','修改密码 ',"","","jiaoshixinxi_updt2.php");
		
		
		d.add(12,2,'authority','','群组信息添加 ',"","","qunzuxinxi_add.php");
		d.add(13,2,'authority','','群组信息查询 ',"","","qunzuxinxi_list2.php");
