...
<div id="Header">
  <div id="Logo"><a href="admins.asp" target="_top"><img src="images/Logo_Main.jpg" alt="" width="155" height="89" /></a></div>
  <div  style="color:#CCCCCC;font-size: 26pt;font-weight: bold; float:left; line-height:80px">在线考试系统</div>
  <ul id="menu">
    <li><a id="top_menu0" href="sy.php" target="frame_main" class="current" onclick="chg_theclass(4,0,'current',1)">管理首页</a></li>
    <li><a id="top_menu1" href="suoping.php" target="_parent">临时离开</a></li>
    
    <!--<li><a id="top_menu2" href="admins_left.asp?mshowvar=1" target="frame_main" onclick="chg_theclass(4,2,'current',1)">配置管理</a></li>-->
    
  <!--  <li><a id="top_menu3" href="yhzhgl.php" target="frame_main" onclick="chg_theclass(4,3,'current',1)">管理员管理</a></li>-->
    
    <li><a id="top_menu4" href="logout.php" target="_parent" onclick="chg_theclass(4,4,'current',1)">退出系统</a></li>
...
<div id="Tool">
  ...
  <div class="Report" id="lscroll_outer" style="overflow: hidden; width: 500px; white-space: nowrap;">
    <table width="800" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<img src="images/man.gif" align="absmiddle" width="14" height="14" />欢迎光临：<strong class="font5bad27 fbold"><?php echo $_SESSION['username'];?>[<?php echo $_SESSION['cx'];?>]</strong>
  ...
  <div class="Toolbar"><a href="logout.php" target="_top" class="a5">退出管理</a><a href="index.php" target="_blank" class="a4">浏览网站</a>
    <a  onclick="javascript:window.parent.frame_main.location.reload();" class="a2" style="cursor:pointer">刷新主页面</a>
    <a href="mod.php" target="frame_main" class="a3">修改密码</a>
